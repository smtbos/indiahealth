...
if (isset($_POST["add"])) {
    ...
    $helper = intval(isset($_POST["helper"]));
    ...
    if ($flag) {
        ...
        // $user_insert = "INSERT INTO `users`(`user_id`, `user_username`, `user_name`, `user_dob`, `user_gender`, `user_mobile`, `user_email`, `user_password`, `user_admin`, `user_doctor`, `user_laboratory`, `user_helper`, `user_patient`, `user_status`) VALUES (NULL, '$username', '$name', '$dob', '$gender', '$mobile', '$email', '$dpassword', '$admin', '$doctor', '$laboratory', ' $helper', '$patient', '$status')";
        $user_insert = "INSERT INTO `users`(`user_id`, `user_name`, `user_dob`, `user_gender`, `user_mobile`, `user_email`, `user_password`, `user_admin`, `user_doctor`, `user_laboratory`, `user_helper`, `user_patient`, `user_status`) VALUES (NULL, '$name', '$dob', '$gender', '$mobile', '$email', '$dpassword', '$admin', '$doctor', '$laboratory', ' $helper', '$patient', '$status')";
...
if (isset($_POST["update"])) {
    ...
    if (mysqli_num_rows($r)) {
        ...
        if ($flag) {
            ...
            $email = mysqli_real_escape_string($con, $email);
            $dpassword = mysqli_real_escape_string($con, $password);
            // $user_insert = "UPDATE `users` SET `user_username` = '$username', `user_name` = '$name', `user_dob` = '$dob', `user_gender` = '$gender', `user_mobile` = '$mobile', `user_email` = '$email', `user_password` = '$password', `user_admin` = '$admin', `user_doctor` = '$doctor', `user_laboratory` = '$laboratory', `user_helper` = '$helper', `user_patient` = '$patient', `user_status` = '$status' WHERE `user_id` = '$uid'";
            $user_insert = "UPDATE `users` SET `user_name` = '$name', `user_dob` = '$dob', `user_gender` = '$gender', `user_mobile` = '$mobile', `user_email` = '$email', `user_password` = '$password', `user_admin` = '$admin', `user_doctor` = '$doctor', `user_laboratory` = '$laboratory', `user_helper` = '$helper', `user_patient` = '$patient', `user_status` = '$status' WHERE `user_id` = '$uid'";
            if (mysqli_query($con, $user_insert)) {
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="row pb-2">
                                    <div class="col-4">
                                        Admin <span class="float-right">:</span>
                                    </div>
                                    <div class="col-8 font-weight-medium">
                                        <?php echo active_deactive($user["user_admin"], 1); ?>
                                    </div>
                                </div>
                                <div class="row pb-2">
                                    <div class="col-4">
                                        Helper <span class="float-right">:</span>
                                    </div>
                                    <div class="col-8 font-weight-medium">
                                        <?php echo active_deactive($user["user_helper"], 1); ?>
                                    </div>
                                </div>
                                <div class="row pb-2">
                                    <div class="col-4">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4 mt-3">
                                            ...
                                            <input type="date" class="form-control" name="dob" id="dob" value="<?php echo $user["user_dob"]; ?>" required>
                                        </div>
                                        <div class="col-4 mt-3">
                                            <label for="gender"><i class="fa fa-question-circle"></i> Gender</label>
                                        ...
                                        <div class="col-4 mt-3">
                                            ...
                                            <input type="text" class="form-control" name="mobile" id="mobile" minlength="10" maxlength="10" value="<?php echo $user["user_mobile"]; ?>" required>
                                        </div>
                                        <div class="col-8 mt-3">
                                            <label for="email"><i class="fa fa-envelope"></i> e-Mail</label>
                                            <input type="text" class="form-control" name="email" id="email" value="<?php echo $user["user_email"]; ?>" required>
                                        </div>
                                        <div class="col-2 mt-3 text-center">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="admin"><i class="fa fa-user"></i> Admin</label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch ">
                                                        <input type="checkbox" class="custom-control-input" id="admin" name="admin" <?php me_check($user["user_admin"]); ?>>
                                        ...
                                        <div class="col-2 mt-3 text-center">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="laboratory"><i class="fa fa-flask"></i> Laboratory</label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch ">
                                        ...
                                        <div class="col-2 mt-3 text-center">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="helper"><i class="fa fa-user-o"></i> Helper</label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch ">
                                                        <input type="checkbox" class="custom-control-input" id="helper" name="helper" <?php me_check($user["user_helper"]); ?>>
                                                        <label class="custom-control-label" for="helper"></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-2 mt-3 text-center">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="patient"><i class="fa fa-user"></i> Patient</label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch ">
                                        ...
                                        <div class="col-12 mt-4 text-center">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="chpass"><i class="fa fa-lock"></i> Generate New Password For This User</label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch ">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4 mt-3">
                                            <label for="mobile"><i class="fa fa-phone"></i> Mobile</label>
                                            <input type="text" class="form-control" name="mobile" id="mobile" minlength="10" maxlength="10" required>
                                        </div>
                                        <div class="col-8 mt-3">
                                            <label for="email"><i class="fa fa-envelope"></i> e-Mail</label>
                                        ...
                                        <div class="col-2 mt-3 text-center">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch ">
                                                        <input type="checkbox" class="custom-control-input" id="helper" name="helper">
                                                        <label class="custom-control-label" for="helper"></label>
                                                    </div>
                                                </div>
                                            </div>
