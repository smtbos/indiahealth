...
<head>
    ...
    <title><?php echo $lab_name; ?>Admin</title>
...
<body class="font-weight-bold">
    <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top ">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><?php echo $lab_name; ?>Admin</a>
                ...
                <ul class="navbar-nav ml-auto ">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            ?>
                                <a class="dropdown-item active" href="index.php"><i class="fa fa-user"></i> Goto Admin</a>
                            <?php
                            }
                            ?>
                            <?php
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item ">
                            <a class="nav-link <?php page_active("index"); ?>" href="index.php" accesskey="a">
                                <i class="fa fa-tachometer"></i> Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  <?php page_active("reports"); ?>" href="reports.php" accesskey="r">
                                <i class="fa fa-list"></i> Reports
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  <?php page_active("users"); ?>" href="users.php" accesskey="u">
                                <i class="fa fa-users"></i> Users
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  <?php page_active("doctors"); ?>" href="doctors.php" accesskey="s">
                                <i class="fa fa-user-md"></i> Doctors
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  <?php page_active("laboratorys"); ?>" href="laboratorys.php" accesskey="l">
                                <i class="fa fa-flask"></i> Laboratorys
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php page_active("templates"); ?>" href="templates.php" accesskey="t">
                                <i class="fa fa-th"></i> Templates
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php page_active("groups"); ?>" href="groups.php" accesskey="g">
                                <i class="fa fa-th-large"></i> Groups
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php page_active("units"); ?>" href="units.php" accesskey="i">
                                <i class="fa fa-square"></i> Units
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php page_active("querys"); ?>" href="querys.php" accesskey="q">
                                <i class="fa fa-inbox"></i> Querys
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php page_active("contacts"); ?>" href="contacts.php" accesskey="c">
