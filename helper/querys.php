...
if (isset($_GET["edit"])) {
    $id = get_num("edit");
    $q = "SELECT * FROM `querys` WHERE `query_id` = '$id' AND `query_handel` = '0'";
...
if (isset($_POST["update"]) || isset($_POST["pass"])) {
    ...
    if (isset($_POST["update"])) {
        ...
        $q = "UPDATE `querys` SET `query_message` = '$message', `query_solved` = '$solved',  `query_handel` = '1' WHERE `query_id` = '$id'";
        if (mysqli_query($con, $q)) {
            $_SESSION["smsg"][] = "Query Passed to Admin";
            header("location:querys.php");
        } else {
            $_SESSION["amsg"][] = "Error";
            header("location:querys.php");
                ...
                <form action="" method="POST">
                    <div class="card border-primary">
                        ...
                        <div class="card-footer">
                            ...
                            <input type="submit" name="pass" value="Pass to Admin" class="btn btn-info mr-3">
