...
<head>
    ...
    <title><?php echo $lab_name; ?>Laboratory</title>
...
<body class="font-weight-bold">
    <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top ">
        <div class="container-fluid">
            <a class="navbar-brand overflow-hidden" href="index.php"><?php echo $lab_name; ?>Laboratory</a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-white"><i class="fa fa-user-circle"></i>&nbsp; <?php echo $login_lab["laboratory_name"]; ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            ?>
                                <a class="dropdown-item active" href="index.php"><i class="fa fa-flask"></i> Goto Laboratory</a>
                            <?php
                            }
                            ?>
                            <?php
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link  <?php page_active("profile"); ?>" href="profile.php">
                                <i class="fa fa-flask" style="font-size: 18px;"></i> Profile
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  <?php page_active("history"); ?>" href="history.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  <?php page_active("fill_report"); ?>" href="fill_report.php">
                                <i class="fa fa-pencil-square-o"></i> Fill Report
                            </a>
                        </li>
                        <li class="nav-item">
